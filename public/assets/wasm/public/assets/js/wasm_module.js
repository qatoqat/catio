...
export function keyDown(key) {
    ...
    const ret = wasm.keyDown(ptr0, len0);
    return ret !== 0;
}
...
export function keyUp(key) {
    const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyUp(ptr0, len0);
    return ret !== 0;
}
 ...
 * @param {boolean} value
 */
export function setJoystickIsShown(value) {
    wasm.setJoystickIsShown(value);
}
 ...
 * @param {number} y
 */
export function setJoystickOrigin(x, y) {
    wasm.setJoystickOrigin(x, y);
}
 ...
 * @param {number} y
 */
export function setJoystickStick(x, y) {
    wasm.setJoystickStick(x, y);
}

/**
 * @returns {boolean}
 */
export function joystickIsShown() {
    const ret = wasm.joystickIsShown();
    return ret !== 0;
}
...
export function setDebugMode(enabled) {
    wasm.setDebugMode(enabled);
}

/**
 * @param {boolean} follow_direction
 */
export function setCameraMode(follow_direction) {
    wasm.setCameraMode(follow_direction);
}

function __wbg_adapter_18(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he577fbd7dc8ba4d5(arg0, arg1);
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_188c4a9b74336ab8 = function(arg0, arg1) {
